...
public abstract class BaseRules implements Rules {
	...
	public boolean generateJavaController() {
		Context context = introspectedTable.getContext();
		JavaControllerGeneratorConfiguration controllerGenerator = context.getJavaControllerGeneratorConfiguration();
	...
	public boolean generateJavaService() {
		Context context = introspectedTable.getContext();
		JavaServiceGeneratorConfiguration serviceGenerator = context.getJavaServiceGeneratorConfiguration();
