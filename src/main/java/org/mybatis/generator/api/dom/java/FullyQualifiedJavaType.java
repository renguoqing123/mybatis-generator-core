...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
	...
	public static final FullyQualifiedJavaType getShortNameInstance(String shortName) {
		if (criteriaInstance == null) {
			criteriaInstance = new FullyQualifiedJavaType(shortName); // $NON-NLS-1$
		}
		return criteriaInstance;
	}

	public static final FullyQualifiedJavaType getShortName(String shortName) {
		return new FullyQualifiedJavaType(shortName);
	}
