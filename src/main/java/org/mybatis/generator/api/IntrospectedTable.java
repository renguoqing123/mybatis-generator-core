...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		/** The add service  */
		ATTR_SERVICE_MYBATIS3,
		/** The add service find  */
		ATTR_SERVICE_MYBATIS3_FIND,
		/** The add service post */
		ATTR_SERVICE_MYBATIS3_POST,
		/** The add service put */
		ATTR_SERVICE_MYBATIS3_PUT,
		/** The add service del */
		ATTR_SERVICE_MYBATIS3_DEL,
		/** The add controller  */
		ATTR_CONTROLLER_MYBATIS3,
		/** The add controller find  */
		ATTR_CONTROLLER_MYBATIS3_FIND,
		/** The add controller post */
		ATTR_CONTROLLER_MYBATIS3_POST,
		/** The add controller put */
		ATTR_CONTROLLER_MYBATIS3_PUT,
		/** The add controller del */
		ATTR_CONTROLLER_MYBATIS3_DEL
	}
	...
	private void calculateJavaServiceAttributes() {
		...
		setMyBatis3ServicePackage(calculateServicePackage());
		setFindStatementId("find", 0); //$NON-NLS-1$
		setPostStatementId("post", 0); //$NON-NLS-1$
		setPutStatementId("put", 0); //$NON-NLS-1$
		setDelStatementId("del", 0); //$NON-NLS-1$
	...
	private void calculateJavaControllerAttributes() {
		...
		setMyBatis3ControllerPackage(calculateControllerPackage());
		setFindStatementId("find", 1); //$NON-NLS-1$
		setPostStatementId("post", 1); //$NON-NLS-1$
		setPutStatementId("put", 1); //$NON-NLS-1$
		setDelStatementId("del", 1); //$NON-NLS-1$
		// generateJavaController(true);
	}

	public String getMyBatis3ControllerPackage() {
		return internalAttributes.get(InternalAttribute.ATTR_CONTROLLER_MYBATIS3);
	}

	private void setMyBatis3ControllerPackage(String pakkage) {
		StringBuilder sb = new StringBuilder();
		sb.append(pakkage);
		sb.append('.');
		sb.append(fullyQualifiedTable.getDomainObjectName());
		sb.append("Controller");
		internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_MYBATIS3, sb.toString());
	}

	private String calculateControllerPackage() {
	...
	public String getMyBatis3ServicePackage() {
		return internalAttributes.get(InternalAttribute.ATTR_SERVICE_MYBATIS3);
	}

	private void setMyBatis3ServicePackage(String pakkage) {
		StringBuilder sb = new StringBuilder();
		sb.append(pakkage);
		sb.append('.');
		sb.append(fullyQualifiedTable.getDomainObjectName());
		sb.append("Service");
		internalAttributes.put(InternalAttribute.ATTR_SERVICE_MYBATIS3, sb.toString());
	}

	private String calculateServicePackage() {
	...
	public void setDelStatementId(String s, int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_FIND, s);
		} else {
			internalAttributes.put(InternalAttribute.ATTR_SERVICE_MYBATIS3_FIND, s);
		}
	}

	public void setPutStatementId(String s, int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_POST, s);
		} else {
			internalAttributes.put(InternalAttribute.ATTR_SERVICE_MYBATIS3_POST, s);
		}
	}

	public void setPostStatementId(String s, int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_PUT, s);
		} else {
			internalAttributes.put(InternalAttribute.ATTR_SERVICE_MYBATIS3_PUT, s);
		}
	}

	public void setFindStatementId(String s, int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			internalAttributes.put(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_DEL, s);
		} else {
			internalAttributes.put(InternalAttribute.ATTR_SERVICE_MYBATIS3_DEL, s);
		}
	}

	public String getDelStatementId(int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			return internalAttributes.get(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_FIND);
		}
		return internalAttributes.get(InternalAttribute.ATTR_SERVICE_MYBATIS3_FIND);
	}

	public String getPutStatementId(int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			return internalAttributes.get(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_POST);
		}
		return internalAttributes.get(InternalAttribute.ATTR_SERVICE_MYBATIS3_POST);
	}

	public String getPostStatementId(int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			return internalAttributes.get(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_PUT);
		}
		return internalAttributes.get(InternalAttribute.ATTR_SERVICE_MYBATIS3_PUT);
	}

	public String getFindStatementId(int k) {
		// TODO Auto-generated method stub
		if (k == 1) {
			return internalAttributes.get(InternalAttribute.ATTR_CONTROLLER_MYBATIS3_DEL);
		}
		return internalAttributes.get(InternalAttribute.ATTR_SERVICE_MYBATIS3_DEL);
	}
