...
public class IntrospectedTableIbatis2Java2Impl extends IntrospectedTable {
	...
	public List<GeneratedXmlFile> getGeneratedXmlFiles() {
		...
		GeneratedXmlFile gxf =
		        new GeneratedXmlFile(document, getIbatis2SqlMapFileName(), getIbatis2SqlMapPackage(), context.getSqlMapGeneratorConfiguration().getTargetProject(), true, context.getXmlFormatter());
